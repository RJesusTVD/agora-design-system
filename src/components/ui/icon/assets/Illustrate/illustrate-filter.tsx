...
export const component = (props: React.SVGProps<SVGSVGElement> | any) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" {...newProps} role="img">
      ...
      />
      <path
        d="M9.02734 19.2458V20.8591C9.02734 21.7403 9.97741 22.2766 10.7245 21.8539C10.7784 21.8234 10.8264 21.7836 10.8715 21.7412L14.4714 18.3532C14.5044 18.3222 14.5398 18.2941 14.5753 18.266L14.5966 18.249C14.8331 18.0602 14.9726 17.7731 14.9726 17.4676V14L9.02734 19.2458Z"
        fill="#034AD8"
      />
    </svg>
  );
